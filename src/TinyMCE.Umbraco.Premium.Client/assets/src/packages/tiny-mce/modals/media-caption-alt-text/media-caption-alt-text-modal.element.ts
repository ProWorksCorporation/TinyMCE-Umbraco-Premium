...
@customElement('tiny-mce-premium-media-caption-alt-text-modal')
export class TinyMcePremiumMediaCaptionAltTextModalElement extends UmbModalBaseElement<
	TinyMceMediaCaptionAltTextModalData,
	TinyMceMediaCaptionAltTextModalValue
> {
	#mediaUnique?: string;
...
export default TinyMcePremiumMediaCaptionAltTextModalElement;

declare global {
	interface HTMLElementTagNameMap {
		'tiny-mce-premium-media-caption-alt-text-modal': TinyMcePremiumMediaCaptionAltTextModalElement;
	}
}
