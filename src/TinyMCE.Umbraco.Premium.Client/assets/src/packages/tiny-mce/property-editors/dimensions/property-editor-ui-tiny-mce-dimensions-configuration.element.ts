...
/**
 * @element umb-property-editor-ui-tiny-mce-premium-dimensions-configuration
 */
@customElement('umb-property-editor-ui-tiny-mce-premium-dimensions-configuration')
export class UmbPropertyEditorUITinyMcePremiumDimensionsConfigurationElement extends UmbLitElement {
...
export default UmbPropertyEditorUITinyMcePremiumDimensionsConfigurationElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-property-editor-ui-tiny-mce-premium-dimensions-configuration': UmbPropertyEditorUITinyMcePremiumDimensionsConfigurationElement;
	}
}
