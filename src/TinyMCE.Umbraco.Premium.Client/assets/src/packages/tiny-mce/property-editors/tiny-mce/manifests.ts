import { manifest as schemaManifest } from './TinyMCEPremium.RichText.js';
...
export const UMB_BLOCK_RTE_PROPERTY_EDITOR_UI_ALIAS = 'TinyMCE.PropertyEditorUI.TinyMCEPremium';

const manifest: ManifestPropertyEditorUi = {
	type: 'propertyEditorUi',
	alias: UMB_BLOCK_RTE_PROPERTY_EDITOR_UI_ALIAS,
	name: 'TinyMCE Premium Rich Text Editor Property Editor UI',
	element: () => import('./property-editor-ui-tiny-mce.element.js'),
	meta: {
		label: 'RTE - TinyMCE.Umbraco.Premium',
		...
		settings: {
			properties: [
				...
				},
				{
					...
					propertyEditorUiAlias: 'TinyMCE.PropertyEditorUI.TinyMCEPremium.ToolbarConfiguration',
					weight: 10,
					config: [
						{
							alias: 'toolbar',
				...
				},
				{
					...
					propertyEditorUiAlias: 'TinyMCE.PropertyEditorUI.TinyMCEPremium.StylesheetsConfiguration',
					weight: 20,
				},
				{
					alias: 'dimensions',
					...
					propertyEditorUiAlias: 'TinyMCE.PropertyEditorUI.TinyMCEPremium.DimensionsConfiguration',
					weight: 30,
				},
				{
					alias: 'maxImageSize',
					...
					propertyEditorUiAlias: 'TinyMCE.PropertyEditorUI.TinyMCEPremium.MaxImageSizeConfiguration',
					weight: 40,
				},
				{
					alias: 'mode',
