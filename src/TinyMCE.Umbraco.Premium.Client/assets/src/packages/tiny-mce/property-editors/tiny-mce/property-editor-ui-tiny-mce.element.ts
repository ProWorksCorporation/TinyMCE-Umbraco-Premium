import type { UmbInputTinyMcePremiumElement } from '../../components/input-tiny-mce/input-tiny-mce.element.js';
...
/**
 * @element umb-property-editor-ui-tiny-mce-premium
 */
@customElement('umb-property-editor-ui-tiny-mce-premium')
export class PropertyEditorUITinyMcePremiumElement extends UmbPropertyEditorUiRteElementBase {
	#onChange(event: CustomEvent & { target: UmbInputTinyMcePremiumElement }) {
...
export default PropertyEditorUITinyMcePremiumElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-property-editor-ui-tiny-mce-premium': PropertyEditorUITinyMcePremiumElement;
	}
}
