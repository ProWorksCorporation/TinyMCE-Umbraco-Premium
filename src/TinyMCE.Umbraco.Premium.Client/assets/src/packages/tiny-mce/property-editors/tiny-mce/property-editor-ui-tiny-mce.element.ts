...
const UMB_BLOCK_RTE_BLOCK_LAYOUT_ALIAS = 'TinyMCEPremium'; // Not rich text, cause this has not been migrated [NL]

/**
 * @element umb-property-editor-ui-tiny-mce-premium
 */
@customElement('umb-property-editor-ui-tiny-mce-premium')
export class PropertyEditorUITinyMcePremiumElement extends UmbLitElement implements UmbPropertyEditorUiElement {
	//
