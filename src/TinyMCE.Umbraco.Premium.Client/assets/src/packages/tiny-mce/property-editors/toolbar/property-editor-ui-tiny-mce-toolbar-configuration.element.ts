...
/**
 * @element umb-property-editor-ui-tiny-mce-premium-toolbar-configuration
 */
@customElement('umb-property-editor-ui-tiny-mce-premium-toolbar-configuration')
export class UmbPropertyEditorUITinyMcePremiumToolbarConfigurationElement
...
export default UmbPropertyEditorUITinyMcePremiumToolbarConfigurationElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-property-editor-ui-tiny-mce-premium-toolbar-configuration': UmbPropertyEditorUITinyMcePremiumToolbarConfigurationElement;
	}
}
